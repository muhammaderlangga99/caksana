<img src="{{ asset('/svg/footer.svg') }}" class="dark:bg-gray-900" alt="daycare">
<footer class="bg-indigo-600 text-white">
    <div class="mx-auto w-full max-w-screen-xl">
        ...
        <div class="px-4 py-6 md:flex md:items-center md:justify-between">
            <span class="text-sm text-white dark:text-gray-300 sm:text-center">© 2024 <a
                    href="https://caksana.com">Caksana</a>. All Rights Reserved.
            </span>
